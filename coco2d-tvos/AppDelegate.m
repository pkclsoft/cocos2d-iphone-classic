...
#if defined(__TV_OS_VERSION_MAX_ALLOWED)
    [sharedFileUtils setTVDisplaySuffix:@"-tv"];
#endif
    
    // Assume that PVR images have premultiplied alpha
    [CCTexture2D PVRImagesHavePremultipliedAlpha:YES];
    
    // create scene and add the scene to the stack. The director will run it when it automatically when the view is displayed.
